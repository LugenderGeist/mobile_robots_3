...
В результате маршрут перестраивается каждую итерацию, и изменяет управление,  что позволяет роботу реагировать на изменения на поле. Пример реакции робота на добавление и удаление препятствий на поле представлены ниже.

<div align="center">
  <img src="files/path1.png" alt="path1" height="300">
  <img src="files/path2.png" alt="path2" height="300">
  <img src="files/path2.png" alt="path3" height="300">   
</div>
